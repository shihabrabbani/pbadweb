...
var classifiedDisplayEditManager = {
    init: function () {   
        classifiedDisplayEditManager.personalActions();
        var title = $('#Title').val();
        ...
        if (!completeMatter) {
            var imagePath = $('#ImageContent').attr('data-default-file');
            var defaultImage = `<img src='${imagePath}' />`
    ...
    loadPhotoInPreview: function () {
        ...
        if (file) {
            ...
            reader.onload = function () {       
                ...
                //classifiedDisplayEditManager.getEstimatedCosting();
            }
    ...
    addDateOffer: function (dateBasedOffer) {
        ...
        classifiedDisplayEditManager.generateBaseOfferDateContainerHtml();

        //get discount by date offer          
        classifiedDisplayEditManager.getDiscountByDateOffer();
...
$(function () {
    classifiedDisplayEditManager.init();
    ...
    $('#CategoryId').on('change', function () {
        ...
        classifiedDisplayEditManager.loadSubCategoryByCategory(categoryId);
    })
    
    $('#Title').on('keyup blur', function () {
        /*
        var prevTitle = $('#previousTitle').val();
        var totalTitleWords = classifiedDisplayEditManager.totalTitleWords();
        ...
        */
        ...
        //get total words
        //classifiedDisplayEditManager.getTotalTitleWords();
    ...
    $('textarea[name="AdContent"]').on('keyup blur', function () {
        ...
        var totalAdContentWords = classifiedDisplayEditManager.totalAdContentWords();
        ...
        */
        ...
        //populate in preview
        classifiedDisplayEditManager.populateInPreview();

        //get total words
        //classifiedDisplayEditManager.getTotalWords();
    ...
    $('.btn-date-based-offer').on('click', function () {
        ...
        if (!(tomorrowFormattedDate === dateBasedOffer)) { //check tomorrow booking
            classifiedDisplayEditManager.addDateOffer(dateBasedOffer);
            return;
        }
    ...
    $('#ImageContent').bind('fileuploadstop', function (e) {
        classifiedDisplayEditManager.loadPhotoInPreview();
    })
    ...
    $('#CompleteMatter').on('click', function () {
        ...
        var adPrevContainer = `
            <p class="classified-display-title text-center font-weight-bolder mb-1"></p>
                <div class="img-thumbnail cls-dis-photoframe image-content-in-preview d-none">
                </div>
            <p class="classified-display-content"></p>
            `;
        $('.classified-display-ad-preview-container').html(adPrevContainer);
    ...
    $('input[type="radio"][name="AdColumnInch"]').on('click', function () {   
        ...
        classifiedDisplayEditManager.getAdColumnInchRate(adColumnInch);
    })
