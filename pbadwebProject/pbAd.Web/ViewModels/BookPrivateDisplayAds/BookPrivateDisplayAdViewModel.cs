...
{
    public class BookPrivateDisplayAdViewModel
    {
    ...
    public class PrivateDisplayEstimatedCostingViewModel
    {
        public int ColumnSize { get; set; }
        public decimal InchSize { get; set; }
        public bool IsColor { get; set; }
        ...
        public int EditionId { get; set; }
        public decimal PerColumnInchColorRate { get; set; }
        public decimal PerColumnInchEARPanelRate { get; set; }
        public decimal PerColumnInchBWRate { get; set; }
    }
}
