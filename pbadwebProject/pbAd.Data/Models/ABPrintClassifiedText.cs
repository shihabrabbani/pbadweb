...
{
    [Table("ABPrintClassifiedText")]
    public class ABPrintClassifiedText
    {
        [Key]
        ...
        [Display(Name = "Is Big Bullet Point Single")]
        [Required(ErrorMessage = "{0} is Required")]
        public bool IsBigBulletPointSingle { get; set; }

        [Display(Name = "Is Big Bullet Point Double")]
        [Required(ErrorMessage = "{0} is Required")]
        public bool IsBigBulletPointDouble { get; set; }

        [Display(Name = "Is Bold")]
        [Required(ErrorMessage = "{0} is Required")]
        public bool IsBold { get; set; }

        [Display(Name = "Is Boldin Screen")]
        [Required(ErrorMessage = "{0} is Required")]
        public bool IsBoldinScreen { get; set; }

        [Display(Name = "Is Bold Screen Single Box")]
        [Required(ErrorMessage = "{0} is Required")]
        public bool IsBoldScreenSingleBox { get; set; }

        [Display(Name = "Is Bold Screen Double Box")]
        [Required(ErrorMessage = "{0} is Required")]
