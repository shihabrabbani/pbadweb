...
{
    [Table("ABPrintPrivateDisplay")]
    public class ABPrintPrivateDisplay
    {
        [Key]
        ...
        [Display(Name = "Private Ad Type")]
        [Required(ErrorMessage = "{0} is Required")]
        [StringLength(50, ErrorMessage = "Maximum length is {1}")]
        public string PrivateAdType { get; set; }

        [Display(Name = "Is Private Display")]
        [Required(ErrorMessage = "{0} is Required")]
        ...
        public virtual ICollection<PrivateDisplayMediaContent> PrivateDisplayMediaContents { get; set; }
